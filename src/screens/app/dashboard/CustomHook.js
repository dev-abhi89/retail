...
export default function UseDashboard() {
    ...
    return [storesData,pagination,search,noPagination,loading,showFilter,filters,setSearch,setShowFilter,setNoPagination,initData,handlePagination,renderItem,handleFilter,handleSearch]
}